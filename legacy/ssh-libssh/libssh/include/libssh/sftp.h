...
typedef struct sftp_dir {
    ...
    unsigned long count; /* counts the number of following attributes structures into buffer */
...
typedef struct {
    ...
    unsigned long long atime64;
    unsigned long atime;
    unsigned long atime_nseconds;
    unsigned long long createtime;
    unsigned long createtime_nseconds;
    unsigned long long mtime64;
    unsigned long mtime;
    unsigned long mtime_nseconds;
    STRING *acl;
    unsigned long extended_count;
...
/* attributes */
/* ssh drafts is completely braindead : version 3 and 4 have different flags for same constants */
